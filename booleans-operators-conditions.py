#Booleans, Arithmetic, Conditional, Logical operators

#Enter a number to check if it is a even number

#If-Else

#print('Enter a number to check if it is a even number: ')
number=int(input('Enter a number to check if it is a even number: '))  # Line number 7 - within the input function
...
if(str(DataType_Result)=='True'):                                  # == one of the conditional operators
# str converts the data type to string
    print('It is a even number')
else:
    print('It is a odd number')


#Enter a number to check if it is divisible by both 3 and 5:
